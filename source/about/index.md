...
- 💻 编程类
    ...
    - 🌐 {% url_for js tags/js %}
    - 🌶️ {% url_for flask tags/flask %}
    - ⚛️ {% url_for electron tags/electron %}
    - 🔥 {% url_for pytorch tags/pytorch %}
    - ⚛️ {% url_for react tags/react %}
...
- 🎯 领域类
    ...
    - ⚛️ {% url_for physics tags/physics %}
    - ⚙️ {% url_for xops tags/xops %}
    - 🔗 {% url_for ... tags %}
